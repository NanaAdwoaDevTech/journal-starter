...
class EntryUpdate(BaseModel):
    """Model for partially updating an existing journal entry."""

    work: ConstrainedStr | None = None
    struggle: ConstrainedStr | None = None
    intention: ConstrainedStr | None = None
